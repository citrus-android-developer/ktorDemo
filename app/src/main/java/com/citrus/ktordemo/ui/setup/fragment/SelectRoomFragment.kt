...
import com.citrus.ktordemo.adapter.RoomAdapter
import com.citrus.ktordemo.databinding.FragmentSelectRoomBinding
import com.citrus.ktordemo.ui.setup.SelectRoomViewModel
import com.citrus.ktordemo.util.Constants.SEARCH_DELAY
...
class SelectRoomFragment : Fragment(R.layout.fragment_select_room) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        roomAdapter.setOnRoomClickListener {
            viewModel.joinRooms(args.username, it.name)
        }
    }

    private fun listenToEvent() = lifecycleScope.launchWhenStarted {
    ...
    private fun subscribeToObserver() = lifecycleScope.launchWhenStarted {
