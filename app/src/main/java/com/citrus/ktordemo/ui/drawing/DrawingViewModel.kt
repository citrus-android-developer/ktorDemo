...
import com.citrus.ktordemo.data.remote.ws.models.DrawAction.Companion.ACTION_UNDO
import com.citrus.ktordemo.ui.views.DrawingView
import com.citrus.ktordemo.util.Constants.TYPE_DRAW_ACTION
import com.citrus.ktordemo.util.Constants.TYPE_DRAW_DATA
import com.citrus.ktordemo.util.CoroutineTimer
...
class DrawingViewModel @Inject constructor(
    ...
    private val _speechToTextEnable = MutableStateFlow(false)
    val speechToTextEnable: StateFlow<Boolean> = _speechToTextEnable
    ...
    fun startListening(){
        _speechToTextEnable.value = true
    }

    fun stopListening(){
        _speechToTextEnable.value = false
    }
    ...
    fun chooseWord(word: String, roomName: String) {
        val choseWord = ChosenWord(word, roomName)
        sendBaseModel(choseWord)
    }
